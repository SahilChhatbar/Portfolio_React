  ...
  return (
    <div id="Experience" className="p-10 md:p-10 md:-mt-10">
      ...
      <div className="flex flex-wrap items-start justify-between gap-0 md:gap-0 p-10 w-fill">
        <div className="flex flex-col w-full md:w-2/5 gap-4 bg-slate-950 bg-opacity-20 rounded-xl p-4 items-center shadow-lg shadow-slate-900 md:mt-14">
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4 w-full">
            ...
            <div className="text-white w-full text-leftr md:text-left ">
              <h2 className="leading-tight font-bold hyphens-auto">
                <b className="text-lg">BSM Pvt. Ltd.</b>,{" "}
                <i>WordPress Developer Intern</i>
              </h2>
        ...
        <div className="hidden md:flex flex-wrap md:w-3/6 w-full gap-4 p-6 text-white items-center justify-center bg-black shadow-lg shadow-slate-900 bg-opacity-20 rounded-2xl md:mt-6 hyphens-auto font-semibold">
          <p>
            During my internship at <b>Big Social Media Pvt. Ltd.</b>, I
            developed skills in professional communication, teamwork, time
            management, problem-solving, adaptability, networking, attention to
            detail, and conflict resolution.
          </p>
          <div className="text-md w-full hyphens-auto">
            <h2 className="font-bold">Projects I worked on:</h2>
            <ul className="list-none ml-1">
              <li className="flex items-center relative">
                <span className="mr-2">→</span>
                <a
                  href="https://bigsocialmedia.in/"
                  target="_blank"
                ...
                <div className="hover-image absolute hidden">
                  <img
                    src="https://i.postimg.cc/rmjQkF8f/Screenshot-661.png"
              ...
              <li className="flex items-center relative">
                <span className="mr-2">→</span>
                <a
                  href="https://selfpublishingindia.co.in/"
                  target="_blank"
                  className="hover-text"
                >
                  selfpublishingindia.in🔗
                </a>
                <div className="hover-image absolute hidden">
                  <img
                    src="https://i.postimg.cc/NjR8tfDR/Screenshot-663.png"
                    alt="Description of image"
                  />
                </div>
              </li>
       ...
       <div className="flex flex-col w-full md:w-2/5 gap-4 bg-slate-950 bg-opacity-20 rounded-xl p-4 items-center shadow-lg shadow-slate-900 md:mt-20">
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4 w-full">
            ...
            <div className="text-white w-full text-leftr md:text-left ">
              <h2 className="leading-tight font-bold hyphens-auto">
                <b className="text-lg">Elixir Techne</b>,{" "}
          ...
          <div className="hidden md:flex flex-wrap md:w-3/6 w-full gap-4 p-6 text-white items-center justify-center bg-black shadow-lg shadow-slate-900 bg-opacity-20 rounded-2xl md:mt-6 hyphens-auto font-semibold">
          <p>
         During my internship at <b>Elixir Techne</b>, I worked with React, TypeScript, Redux, Tailwind CSS, Git, and APIs, while collaborating using Figma and React UI libraries like ShadCN and Mantine. I contributed to the company’s internal <b>PMS</b>—a dashboard for project, HR, and employee management. Alongside technical growth, I strengthened soft skills such as communication, teamwork, time management, adaptability, and collaboration.
          </p>
        </div>

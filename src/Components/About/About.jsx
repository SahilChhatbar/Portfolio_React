      ...
      <ul className="space-y-4">
        ...
        <li className="flex gap-3 items-start">
          ...
          <p className="text-sm md:text-lg leading-tight hyphens-auto font-semibold">
            I'm a MERN Stack and WordPress Developer specializing in building and managing websites and web applications. Explore my work in the Projects section.</p>
          </div>
        </li>
        <li className="flex gap-3 items-start">
          <div className="flex-grow">
       ...
       <div className="flex flex gap-2 md:gap-6 justify-center"><button className="button-gradient text-#94a3b8 py-2 px-3 text-sm md:text-lg md:py-2 md:px-4 hover:opacity-85 duration-300 hover:scale-105 font-semibold rounded-3xl bg-[#673ab7] text-center">

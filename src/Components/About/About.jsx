import { FaJs, FaReact } from 'react-icons/fa'
 ...
 const About = () => {
   return (
     <div id="About"
       className="text-white md:flex overflow-hidden items-center md:flex-wrap md:justify-center bg-black shadow-lg shadow-slate-900 mx-0 md:mx-20 md:my-10 bg-opacity-25 rounded-2xl p-12 md:p-20 relative">
       <div>
   ...
   <div className="flex flex-wrap w-full gap-2 items-center justify-center">
     <span className="p-2 bg-zinc-950 flex items-center rounded-2xl">
      ...
      <span className="p-2 bg-slate-300 flex items-center rounded-2xl">
       <SiNextdotjs color="#202020" size={50} />
     </span>
     <span className="p-2 bg-zinc-950 flex items-center rounded-2xl">
     ...
     <div className="flex flex-col ">
       <ul className="space-y-4">
        ...
        <div className="flex flex gap-1 md:gap-6 justify-center"><button className="button-gradient text-#94a3b8 py-2 px-3 text-sm md:text-lg md:py-2 md:px-4 hover:opacity-85 duration-300 hover:scale-105 font-semibold rounded-3xl bg-[#673ab7] text-center">
           ...
           <a href="https://drive.google.com/file/d/1z52iHCECz8LyeXDIWOdf8uZ3BynfUnh2/view?usp=drive_link" target="_blank">My Résumé</a>
           </button></div>
       </ul>
     </div>
   </div></div>

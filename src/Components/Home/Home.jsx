  ...
  return (
    <div id="Home" className="text-#94a3b8 flex flex-col md:flex-row w-full justify-between items-center p-5 md:p-20">
      <div className="md:w-4/5 text-center md:text-left md:pt-10">
        ...
        A Result-Oriented Web Developer specializing in building and managing websites to deliver innovative solutions and enhanced user experiences. I have a passion for programming and love learning about new technologies.</p>
